...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(name="Урок 1", owner=self.user, video_url="https://youtube.com")
    ...
    def test_lesson_update(self):
        ...
        data = {"name": "Тест апдейт", "description": "Описание апдейт", "video_url": "https://youtube.com"}
        response = self.client.put(url, data)
        data = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(data.get("name"), "Тест апдейт")
    ...
    def test_course_create_by_moderator_forbidden(self):
        ...
        data = {"name": "Курс от модератора", "description": "Описание курса"}
