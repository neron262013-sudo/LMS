...
class Course(models.Model):
    ...
    preview = models.ImageField(upload_to='materials/course_previews', verbose_name='Превью', help_text='Загрузите превью', blank=True, null=True)
...
class Lesson(models.Model):
    ...
    preview = models.ImageField(upload_to='materials/lessons_previews', verbose_name='Превью', help_text='Загрузите превью',
    ...
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, verbose_name='Курс', help_text='Укажите из какого курса урок', blank=True, null=True)
